...
import type { SpatialCaptureArtifact, SpatialVerification } from './receipt.js';
import { getSpatialObject, type WorldGraph } from './world-graph.js';
...
export function createSpatialTools(runtime: SpatialRuntime) {
  return {
